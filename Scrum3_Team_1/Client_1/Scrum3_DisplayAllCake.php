...
<html lang="en">
  <head>
    ...
    <title>Scrum 3 Team 1 - Cakes</title>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="Scrum3_DisplayAllCake.php">View Cakes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="Scrum3_DisplayAllCookies.php">View Cookies</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="Scrum3_DisplayAllCupcakes.php">View Cupcakes</a>
              </li>
              <li class="nav-item">
...
<script>
  ...
  $.ajax({
    ...
    data: 'tableName=cakes&action=read',
    dataType: 'json',
    encode: true
  })
  .done(function(data) {
    ...
    for (i = 0; i < length; i++)
    {
      //This breaks the returned string from the api and breaks it into its parts
  ...
  function addItem() {
    ...
    type: 'GET',
    url: '../Provider_1/testers/API_3.php',
    data: 'tableName=cakes&action=add&id='+ values[0],
    dataType: 'json',
    encode: true
  })
  .done(function(data) {
  ...
  function deleteItem($id) {
    ...
    type: 'GET',
    url: '../Provider_1/testers/API_3.php',
    data: 'tableName=cakes&action=delete&id='+$id,
    dataType: 'json',
    encode: true
  })
  .done(function(data) {
